...
success_rates = read_csv_files('downlink_basic', 'Q_learning_boltzmann', 10, 'success_rate.csv')
success_rate_mean = np.mean(success_rates, axis=0)
success_rate_std = np.std(success_rates, axis=0)
x = np.arange(1, configs.UPDATE_NUM, 20)
...
sum_data_rates = read_csv_files('downlink_basic', 'Q_learning_boltzmann', 10, 'sum_data_rate.csv')
