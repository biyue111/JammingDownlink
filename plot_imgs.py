...
success_rates = read_csv_files('downlink_basic', 'DDPG_PNN_INT', 10, 'success_rate.csv')
...
sum_data_rates = read_csv_files('downlink_basic', 'DDPG_PNN_INT', 10, 'sum_data_rate.csv')
